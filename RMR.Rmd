...
# prepare x and y 
prepped_training_data <- orig_scale_recipe |> step_select(c(all_predictors(), all_outcomes())) |> prep() |> juice()
...
# anova(selected_lm_fits$selected_linear, selected_lm_fits$quadratic_linear)
# anova(selected_lm_fits$quadratic_linear, selected_lm_fits$interaction_linear)
...
### Testing Errors
```{r, testing-errors, fig.width=12, fig.height=6}
testing_preds <-
  data.table::rbindlist(
    sapply(
